...
public class UserController {
    ...
    public String requestParam1(String name, int age) {
        ...
        return "/page.jsp";//跳转到webapp下的page.jsp页面
    }
    ...
    public String requestParam2(@RequestParam(value = "userName", required = true) String name) {
        ...
        return "page.jsp";// 不加'/'跳转到webapp下的user下的page.jsp页面
    }
    ...
    //public Map<String,Address> addressMap  --> put
    ...
    //数据类型转换，使用自定义类型转换器，需要配置后方可使用默认为为1999/09/09格式
