...
//            log.info("User with authKey '{}', ws-id {} session {} make a WebSocket connection and generated the user {}", apiKey, wsId, sessionId);
//
//        }
//
//        return message;
...
//        if (accessor == null) {
//            throw new RuntimeException("Fail to read headers.");
//        }
//        return accessor;
//    }
//
...
//                .orElseThrow(() -> new RuntimeException("Session header not found")).toString();
//    }
//
...
//            throw new RuntimeException("Auth Key Not Found");
//        return authKey;
//    }
//
...
//            throw new RuntimeException("Web Socket ID Header not found");
//        return wsId;
//    }
//
