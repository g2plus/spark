    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li id="question-manager">
                ...
                <!--测试使用，浏览器不能直接访问web-in下的内容-->
                <a href="${ctx}/store/question?operation=show" onclick="setSidebarActive(this)" target="iframe">
                    <i class="fa fa-circle-o"></i>图片显示测试
                </a>
            </li>
