...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/store/questionItem?operation=${operation}" method="post" <%--enctype="multipart/form-data"--%>>
                <input type="text" name="questionId" value="${questionId}">${operation}
                <input type="text" name="id" value="${questionItem.id}">
                <!--修改operation=saveOrUpdate，实现save与update功能的合二为一，根据是否有id来却区分调用方法-->
