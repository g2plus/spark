                ...
                <div class="pull-left">
                    <div class="form-group form-inline">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-default" title="测试文件上传" onclick='location.href="${ctx}/store/question?operation=toUpload"'><i class="fa fa-file-o"></i> 测试文件上传</button>
...
--%>
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                        ...
                        <td>${o.picture}</td><!--判断是否有值来判断是否有图片上传-->
