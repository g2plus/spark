...
<div class="easyui-layout" data-options="fit:true">
    <div data-options="region:'north',split:true,title:'查询条件'"
         style="height:90px;padding:5px; border-width: 0 0 1px 0;">
                ...
                <tr>
                    ...
                    <td width="150">
                        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'"
                           onclick="doSearch('resList',true,true)">查 询</a>&nbsp;&nbsp;
                        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-reload'"
                           onclick="doReload('${ctx}/resource/listInitialize')">重 置</a>
                    </td>
                    <td width="*">&nbsp;</td>
                </tr>
            </table>
    ...
    <div data-options="region:'west',title:''" style="width:220px;height: 300px;">
        <iframe id="listTree" width="100%" height="95%" allowtransparency="true" frameborder="0" scrolling="auto"
                src="${ctx}/resource/listTree"></iframe>
    </div>
    ...
    <div id="toolButton" style="display: none;">
        <a href="#" id="addbtn" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'"
           onclick="addDataInfoRefresh('resList','资源添加','${ctx}/resource/input',$(document).width()*0.7,$(document).height()*0.85,true,true,true)">新增</a>
        <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-edit'"
           onclick="updateDataInfoRefresh('resList','资源修改','${ctx}/resource/input',$(document).width()*0.7,$(document).height()*0.85,true,true)">修改/查看</a>
        <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-remove'"
           onclick='delDataInfoRefresh("resList","${ctx}/resource/delete",true,true)'>删除</a>
    </div>
</div>
</body>
</html>